  ...
  return (
      <div className="min-h-screen w-full flex">
        ...
        <div className="hidden lg:flex lg:w-[44%] bg-[#0b0b12] flex-col justify-between p-12 relative overflow-hidden select-none">
          ...
          <div className="absolute top-0 left-0 w-24 h-px bg-linear-to-r from-[#6c5ce7] to-transparent" />
          ...
          <div className="relative z-10">
            ...
            <p className="mt-5 text-sm text-white/30 leading-relaxed max-w-[18rem]">
              Manage servers, automate deployments, and monitor your
            ...
            <div className="mt-10 flex flex-col gap-3">
              {[
                ...
                <div
                  key={item.label}
                  className="flex items-center justify-between max-w-56"
                >
        ...
        <div className="flex-1 bg-white flex items-center justify-center px-6 py-10 lg:px-16">
          ...
          >
            ...
            <div className="lg:hidden mb-8 flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-[#0b0b12]">
                CloudForge
              </span>
            </div>
              ...
              {error && (
                ...
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    className="h-3.5 w-3.5 text-red-500 shrink-0 mt-px"
                    stroke="currentColor"
                    strokeWidth={2.2}
                  >
